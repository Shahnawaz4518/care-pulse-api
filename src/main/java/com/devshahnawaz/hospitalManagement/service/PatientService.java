...
public class PatientService {
    ...
    /**
     * getAllPatients(page, size) – paginated version returning DTOs.
     * Used by AdminController to support ?page=&size= query params.
     */
    @Transactional
    public List<PatientResponseDto> getAllPatients(Integer page, Integer size) {
        ...
        return patientRepository.findAll(pageable)
                ...
                .map(patient -> PatientResponseDto.builder()
                        ...
                        .appointmentIds(patient.getAppointments() != null
